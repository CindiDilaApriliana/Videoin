                ...
                <div class="col mb-5 video-item"> <!-- Add 'video-item' class here -->
                    <div class="card h-80"> <!-- Change 'h-200' to 'h-100' for better display -->
                        <div class="card-body">
                            ...
                            <video width="100%" height="auto" controls class="restricted-video" data-video-id="<?php echo e($video->id); ?>">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-start">
                                <!-- Title -->
                                <h5 class="fw-bolder"><?php echo e($video->title); ?></h5>
                                <!-- Description -->
                                <h7><p>Deskripsi: </h7><?php echo e($video->description); ?></p>
                                <!-- Upload date -->
                                <h7><p>Uploaded: </h7><?php echo e($video->created_at->format('F j, Y')); ?></p>
                                <!-- Product actions-->
...
document.getElementById('button-search').addEventListener('click', function() {
    ...
    </script><?php /**PATH C:\xampp\htdocs\Video\resources\views/tampilan.blade.php ENDPATH**/ ?>